    ...
    <div class="card shadow-sm border-0 mb-4 rounded-4">
        <div class="card-body p-4">
            <form action="{{ route('admin.tournaments.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <label class="form-label text-secondary fw-medium">Thumbnail <span class="text-danger">*</span> <small class="text-muted">(Max 2MB, JPG, PNG, WebP)</small></label>
                        <div class="position-relative border rounded-3 d-flex align-items-center justify-content-center @error('thumbnail') border-danger @enderror" style="height: 240px;">
                            ...
                            <div id="thumbnail-preview-overlay" class="position-absolute w-100 h-100 d-flex align-items-center justify-content-center border border-success bg-white rounded-3" style="pointer-events: none;">
                            ...
                            <img id="thumbnail-image-preview" src="#" alt="Thumbnail Preview" class="position-absolute w-100 h-100 d-none" style="object-fit: cover; border-radius: 0.25rem;">
                        </div>
                        @error('thumbnail')
                    ...
                    <div class="col-md-6">
                        <div class="d-flex flex-column justify-content-between h-100">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control border-success rounded-3 @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" required>
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control border-success rounded-3 @error('location') is-invalid @enderror" id="location" name="location" value="{{ old('location') }}" required>
                                @error('location')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="gender_category" id="gender_category" class="form-select border-success rounded-3 @error('gender_category') is-invalid @enderror" required>
                            ...
                            <option value="mixed" {{ old('gender_category') == 'mixed' ? 'selected' : '' }}>Mixed</option>
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control border-success rounded-3 @error('contact_person') is-invalid @enderror" id="contact_person" name="contact_person" value="{{ old('contact_person') }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control border-success rounded-3 @error('registration_fee') is-invalid @enderror" id="registration_fee" name="registration_fee" value="{{ old('registration_fee') }}" required min="0">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control border-success rounded-3 @error('prize_total') is-invalid @enderror" id="prize_total" name="prize_total" value="{{ old('prize_total') }}" required min="0">
                        @error('prize_total')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control border-success rounded-3 @error('max_participants') is-invalid @enderror" id="max_participants" name="max_participants" value="{{ old('max_participants') }}" min="1">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control border-success rounded-3 @error('registration_start') is-invalid @enderror" id="registration_start" name="registration_start" value="{{ old('registration_start') }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control border-success rounded-3 @error('registration_end') is-invalid @enderror" id="registration_end" name="registration_end" value="{{ old('registration_end') }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="datetime-local" class="form-control border-success rounded-3 @error('event_start') is-invalid @enderror" id="event_start" name="event_start" value="{{ old('event_start') }}">
                        @error('event_start')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="datetime-local" class="form-control border-success rounded-3 @error('event_end') is-invalid @enderror" id="event_end" name="event_end" value="{{ old('event_end') }}">
                        @error('event_end')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="visibility_status" id="visibility_status" class="form-select border-success rounded-3 @error('visibility_status') is-invalid @enderror" required>
                            <option value="Draft" {{ old('visibility_status') == 'Draft' ? 'selected' : '' }}>Draft</option>
                            <option value="Published" {{ old('visibility_status') == 'Published' ? 'selected' : '' }}>Published</option>
                        </select>
                        ...
                        @if(old('rules'))
                            @foreach(old('rules') as $index => $ruleText)
                                <div class="input-group mb-3">
                                    <input type="text" name="rules[]" class="form-control border-success rounded-3" placeholder="Rule text..." value="{{ $ruleText }}" {{ $loop->first ? 'required' : '' }}>
                                    <button type="button" class="btn btn-danger remove-rule" {{ $loop->first ? 'disabled' : '' }}>Remove</button>
                                </div>
                            @endforeach
                        @else
                            <div class="input-group mb-3">
