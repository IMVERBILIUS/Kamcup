    ...
    <div
        ...
        @else
            <a href="{{ route('login') }}" class="btn btn-lg fw-bold px-5 py-3 rounded-pill"
                style="background-color: #F4B704; border-color: #F4B704; color: #212529;">DONASI</a>
        @endauth
    </div>
</div>
    </div>
...
@push('styles')
    ...
    <style>
        ...
        .card a.btn { background-color: #F4B704 !important; border-color: #F4B704 !important; color: #212529 !important; transition: all 0.3s ease; }
        .card a.btn:hover { background-color: #e0ac00 !important; border-color: #e0ac00 !important; color: #212529 !important; }
        .event-status-badge { padding: 0.3em 0.6em; border-radius: 0.25rem; font-size: 0.75em; font-weight: 600; line-height: 1; white-space: nowrap; text-align: center; vertical-align: baseline; transition: all 0.3s ease-in-out; color: white; }
        .event-status-badge.status-registration { background-color: #F4B704; color: #212529; }
        .highlight-text { color: #F4B704; }
        .main-text { color: #0F62FF; }
        .card-title.fw-bold { font-size: 1.25rem; }
        @media (max-width: 767.98px) {
            .card-body.flex-column { align-items: center !important; }
