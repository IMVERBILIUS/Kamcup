{{-- ====================================================================== --}}
{{-- ==  PARTIAL UNTUK TRANSLASI OTOMATIS (SEAMLESS & INVISIBLE)         == --}}
{{-- ====================================================================== --}}
{{-- Versi ini menggunakan JavaScript untuk secara aktif menghapus banner  --}}
{{-- Google Translate, memastikan banner tidak akan pernah muncul.         --}}
{{-- ====================================================================== --}}

{{-- Container untuk elemen Google Translate, tetap disembunyikan --}}
<div id="google_translate_element_invisible" style="display:none !important;"></div>

{{-- Memuat dan menginisialisasi skrip Google Translate --}}
...
{{-- ====================================================================== --}}
{{-- ==  SKRIP PENGHAPUS BANNER (METODE JAVASCRIPT)                      == --}}
{{-- ====================================================================== --}}
<script type="text/javascript">
