...
<body>
    <div class="container-404">
        ...
        <a href="<?php echo e(url('/')); ?>" class="cta-button">Kembali ke Halaman Utama</a>
        <p class="footer-text">Kami berkomitmen pada pertumbuhan dan semangat kompetisi yang sehat.</p>
    </div>
</body>
</html>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Kamcup/resources/views/errors/404.blade.php ENDPATH**/ ?>