    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            ...
            <div class="d-flex justify-content-between mb-4 mt-4">
                <a href="<?php echo e(route('front.index')); ?>" class="btn px-4 py-2"
            ...
            <div class="mb-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <span class="badge rounded-pill px-3 py-2"
                          style="background-color: <?php echo e($article->status == 'Published' ? '#E6F7F1' : '#f5f5f5'); ?>;
                                color: <?php echo e($article->status == 'Published' ? '#36b37e' : '#6c757d'); ?>;">
                ...
                <h1 class="fw-bold mb-3 article-text"><?php echo e($article->title); ?></h1>
                ...
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <p class="mb-0 fw-medium"><?php echo e($article->author); ?></p>
            ...
            <div class="mb-4">
                ...
                <div class="article-description mb-4">
                    <div class="p-3 rounded-3" style="background-color: #F8FAFD;">
                        <p class="lead mb-0" style="color: #5F738C;"><?php echo e($article->description); ?></p>
                    </div>
                </div>
                            ...
                            <div class="subheading-section mb-4">
                                ...
                                <?php $__currentLoopData = $subheading->paragraphs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paragraph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="paragraph mb-4">
                                        <p style="line-height: 1.8; color: #5F738C;"><?php echo e($paragraph->content); ?></p>
                                    </div>
            ...
            <div class="card border-0 rounded-4 shadow-sm mb-4">
                <div class="card-body p-4">
                    <h3 class="fw-bold fs-5 mb-4 article-text">Komentar (<?php echo e($article->comments->count()); ?>)</h3>

                    <!-- Comment Form -->
                    <?php if(auth()->guard()->check()): ?>
                        <form action="<?php echo e(route('comments.store', $article->id)); ?>" method="POST" class="mb-4">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php else: ?>
                        <div class="alert alert-info">
                            ...
                            Silakan <a href="<?php echo e(route('login')); ?>">login</a> untuk memberikan komentar.
                        </div>
                    <?php endif; ?>
...
<?php $__env->startPush('translation-script'); ?>
    <?php echo $__env->make('partials.floating-translate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopPush(); ?>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Kamcup/resources/views/front/article_show.blade.php ENDPATH**/ ?>